...
import { HiCheckCircle, HiXCircle, HiPencilSquare } from "react-icons/hi2";
          ...
          >
            <div className="flex items-start justify-between">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    {employee.status === "active" ? (
                      ...
                      <HiXCircle className="h-5 w-5 text-red-500" title="Không hoạt động" />
                    )}
                  </div>
              ...
              <button
                ...
                className="ml-4 inline-flex items-center p-2 border border-gray-300 shadow-sm rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 flex-shrink-0"
                title="Chỉnh sửa"
              >
