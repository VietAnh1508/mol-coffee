...
export function PayrollDataDisplay({ payrollData, selectedPeriod }: PayrollDataDisplayProps) {
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="text-sm font-medium text-gray-500">Tổng tiền lương</div>
          <div className="text-2xl font-bold text-gray-900">
            {formatMoney(Math.round(payrollData.reduce((sum, emp) => sum + emp.totalSalary, 0)))} ₫
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        {payrollData.map((employee) => (
          <div key={employee.employee.id} className="bg-white rounded-lg shadow">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500">{employee.employee.email}</p>
                </div>
            ...
            {/* Activity Breakdown */}
            <div className="p-6">
              <h4 className="text-sm font-medium text-gray-700 mb-3">Chi tiết theo hoạt động</h4>
